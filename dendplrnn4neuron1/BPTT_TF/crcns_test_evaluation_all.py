...
test_data_path = np.load("Experiments/my_exp/crcns_data/crcns_answer_testset.npy", allow_pickle=True)

data_path = "Experiments/my_exp/crcns_data/crcns_test_stim.npy"
...
for i in range(13):
    ...
    file_train = h5py.File("data/challengeAfull_val.hdf5")
...
np.save(directory + '/all_data_spikes.npy', all_data_spikes)
np.save(directory + '/all_model_gammas.npy', all_model_gammas)
np.save(directory + '/best_model_performance.npy', best_model_performance)
